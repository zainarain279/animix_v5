...
async function main() {
  ...
  console.log(colors.green("║                                  ║"));
  console.log(colors.cyan("║  ZAIN ARAIN                      ║"));
  console.log(colors.cyan("║  AUTO SCRIPT MASTER              ║"));
  console.log(colors.green("║                                  ║"));
  console.log(colors.blue("║  JOIN TELEGRAM CHANNEL NOW!      ║"));
  ...
  while (true) {
    ...
    console.log(`[${new Date().toLocaleTimeString()}] Complete all accounts | Waiting ${settings.TIME_SLEEP} minute=============`.magenta);
